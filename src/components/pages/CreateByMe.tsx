...
import { IoAddSharp, IoCloudUploadOutline } from "react-icons/io5";
...
import CreatedByMeTable from "../tables/BasicTables/CreatedByMeTable";
import { IoIosArrowDown } from "react-icons/io";
import { MdFormatListBulleted, MdOutlineFormatListNumbered, MdOutlineTextFields } from "react-icons/md";
    ...
    return (
        <div>
                ...
                <form>
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-200 bg-white py-2.5 pl-12 pr-14 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400  focus:outline-hidden focus:ring-1 focus:ring-[#ffe4e6] dark:border-gray-800 dark:bg-gray-900 dark:bg-white/[0.03] dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 xl:w-[430px]"
                        />
                    </div>
                </form>
            ...
            <div className="flex gap-5 items-center mt-5">
                ...
                <div className="relative">
                    <button
                        className="flex items-center gap-2 border bg-white rounded-md p-2"
                ...
                <div className="relative">
                    <button
                        className="flex items-center gap-2 border bg-white rounded-md p-1"
            ...
            {isModalOpen && (
                <div onClick={ModalTrigger} className="fixed inset-0 flex items-center justify-center bg-black/50 z-99999">
                    <div onClick={(e) => e.stopPropagation()} style={{ scrollbarWidth: "thin" }} className="bg-white w-200 h-[90vh] overflow-auto  rounded-md shadow-lg py-10 px-14 relative">
