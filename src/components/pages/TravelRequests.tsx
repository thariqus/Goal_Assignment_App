    ...
    <div>
      <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-4">
          ...
          <div className="grid grid-cols-3 justify-between mt-5 gap-2">
      ...
      <div className=" p-5 dark:border-gray-800 dark:bg-white/[0.03] md:my-4 md:px-0 md:py-0">
        {/* <div className="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
          <GroupIcon className="text-gray-800 size-6 dark:text-white/90" />
        </div> */}


        <div className="grid  grid-cols-3 justify-between mt-0 gap-2">
          <div className="border flex flex-col gap-4 bg-white px-6 rounded-2xl text-center py-6 cursor-pointer">
            <span className="text-sm text-gray-500 dark:text-gray-400">
              Meetings
            </span>
            <div className="border px-2 rounded-2xl bg-[#ffe4e6]  py-8 cursor-pointer">
              <span className="text-sm text-gray-500 dark:text-gray-400">
                Open
              </span>
              <h4 className="mt-2 font-bold text-gray-800 text-title-sm dark:text-white/90">
