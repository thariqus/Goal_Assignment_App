...
function AssessmentDetailReport() {
    const [reports, setReports] = useState<Reports[]>([
        { id: "1", evaluation: "2011-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, date: "2023-4-4", Status: "pending" },
        { id: "2", evaluation: "2015-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, date: "2023-4-4", Status: "pending" },
        { id: "3", evaluation: "2025-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, date: "2023-4-4", Status: "pending" },
    ]);
    ...
    return (
        <div className='border h-full flex flex-col gap-5 rounded-lg bg-white px-6 '>

            <form action="" className='h-full flex flex-col gap-5  bg-white py-10 '>
                <h1 className='text-xl font-medium pb-5'>Evaluation Details Report</h1>
                {/* Evaluation dropdown */}
...
export default AssessmentDetailReport;
