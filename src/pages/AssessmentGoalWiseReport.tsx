...
function AssessmentGoalWiseReport() {
    const [reports, setReports] = useState<Reports[]>([
        { id: 1, evaluation: "2011-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, goaldetails: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout" },
        { id: 2, evaluation: "2015-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, goaldetails: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout" },
        { id: 3, evaluation: "2025-03-3 Evaluation", name: "Saji Jose", percentageachieved: 50, goaldetails: "It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout" },
    ]);

    const [openDropdown, setOpenDropdown] = useState<string | null>(null);
    const [selectedEvaluation, setSelectedSEvaluation] = useState<string>("Select Evaluation");
    const [showReport, setShowReport] = useState(false);
    const [selectedEmployee, setSelectedEmployee] = useState<string>("Select Employee");
    const [selectedGoal, setSelectedGoal] = useState<string>("Select Goal");
    ...
    const goals = ["Redesign Website", "Optimize Database Queries"]
    ...
    return (
        <div className='border h-full flex flex-col gap-5 rounded-lg bg-white px-6 py-10'>
            <div >
                <form className='h-full flex flex-col gap-5  bg-white '>
                    <h1 className='text-xl font-medium pb-5'>Goalwise Evaluation Report</h1>
                    ...
                    <div className="relative dropdown-container">
                        <div className="flex gap-22">
                            ...
                            <div>
                                ...
                                >
                                    <span className={selectedGoal === "Select Goal" ? "text-gray-400" : "text-black"}>
                                        {selectedGoal}
                                    </span>
                                    <IoIosArrowDown style={{ color: "gray" }} />
                                </button>
                                ...
                                {openDropdown === "goal" && (
                                    <div className="absolute left-35 mt-1 w-48 border rounded-md shadow-sm bg-white z-[1000]">
                                        ...
                                        <ul className="font-normal max-h-40 overflow-y-auto">
                                            {goals
                                                .filter(item => item.toLowerCase().includes(searchGoal.toLowerCase()))
                                                .map((item) => (
                                                    <li
                                                        key={item}
                                                        className="px-4 py-2 hover:bg-gray-200 cursor-pointer"
                ...
                {showReport && (
                    <>
                        ...
                        {/* Table */}
                        <div className='mt-10'>
                            <h3 className='text-xl mb-8 text-center text-[#972E26]'>Report for the period of 2025 sep 03</h3>
                                ...
                                <table className="w-full text-left">
                                    <thead className="text-gray-500 border-b">
                                        <tr>
                                            ...
                                            <th className="py-3 font-medium px-4">Employee Name </th>
                                            <th className="py-3 w-[500px] font-medium px-4">Goal Details</th>
                                            <th className="py-3 font-medium px-4">% Achieved</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {currentRows.map((item) => (
                                            <tr key={item.id} className="border-b hover:bg-gray-50 transition">
                                                ...
                                                <td className="py-3 px-4">{item.goaldetails}</td>
                                                <td className="py-3 px-4">{item.percentageachieved} %</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
...
export default AssessmentGoalWiseReport;
